## Asynchronous Bash Script Runner
  ...
  - **Reserved functions:** `kill_signal_`, `timestamp_`, `subpid_`, `ps_subpids_`, `update_`, `refresh_`, `refresh_status_`, `ipclock_`
